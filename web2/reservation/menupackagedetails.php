...
//            }
            ...
            if (empty($message)) {
              ...
              //  var_dump($_SESSION['reservation']['packagedetails']);
//                $db = dbConn();
//                
//                
//
                        ...
                        <form enctype="multipart/form-data" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>"> 
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label for="menupackage" class="col-form-label">Menu Package Name <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-12 mb-2 mt-3">
                                            ...
                                            <input type="text" class="form-control" id="menuprice" name="menuprice" value="<?= number_format(@$menuprice,2,'.') ?>" readonly>
                                            <div class="text-danger">
                                        ...
                                        <div class="col-md-12 mb-2 mt-3">
                                            ...
                                            <input type="text" class="form-control" id="totalmenuprice" name="totalmenuprice" onchange="form.submit()" value="<?= number_format(@$totalmenuprice,2,'.') ?>" readonly>
                                            <div class="text-danger">
                                    ...
                                    <div class="card">
                                        <div class="card-header bg-secondary text-white text-center">
                                            ...
                                            if (!empty($menupackage)) {
                                                ...
                                                $result = $db->query($sql);
                                                $row = $result->fetch_assoc();
                                                echo  "<h4>".$row['MenuPackageName']."</h4>";
                                            }
                                            ?>
