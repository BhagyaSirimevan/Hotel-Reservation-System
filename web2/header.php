...
<head>
  ...
  <!-- Favicons -->
  <link href="<?= WEB_PATH?>assets/img/favicon.png" rel="icon">
  ...
  <!-- Vendor CSS Files -->
  <link href="<?= WEB_PATH?>assets/vendor/animate.css/animate.min.css" rel="stylesheet">
  ...
  <link href="<?= WEB_PATH?>assets/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
  ...
  <link href="<?= WEB_PATH?>assets/css/style.css" rel="stylesheet">
