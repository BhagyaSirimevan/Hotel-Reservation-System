                        ...
                        <div id="home" class="container tab-pane active"><br>
                            ...
                            <form enctype="multipart/form-data" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>"> 
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-md-5">
                                        <img src="assets/img/hotel.jpg" width="500px" height="320px" alt="alt"/>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <a href="menu1" class="btn btn-primary" style="width: 150px" name="action" value="reservation">Next</a>
...
//}
                                ...
                                <div class="row">
                                    <div class="col-md-1">
                                        <a href="?tab=menu1" class="btn btn-secondary" style="width: 150px" name="action" value="previous">Previous</a>
                                    </div>
                                    <div class="col-md-9">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <a href="?tab=payment" type="submit" name="action" value="package" class="btn btn-primary" style="width: 150px">Next</a>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <img src="assets/img/payment1.png" width="350px" height="350px" alt="alt"/>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    1. Payment Schedule: The payment schedule may be determined based on the duration of the service or the frequency of use, and payments may be due in installments or at the end of each billing period.
                                                    <br>  <br>
                                                    2. Payment Method: Payment may be made by credit card, debit card, bank transfer, or other payment methods. Some providers may also accept cash payments.
                                                    <br>  <br>
                                                    3. Late Payment Penalties: Late payment penalties may be imposed if payment is not made on time. These penalties may be a fixed amount or a percentage of the total payment due.
                                                    <br>  <br>
                                                    4. Refund Policy: The provider may have a refund policy in place if the service is not satisfactory or if the customer cancels the service before the agreed-upon period.
                                                    <br>  <br>
                                                    5. Cancellation Policy: There may be a cancellation policy that outlines the conditions under which the customer can cancel the service and whether any cancellation fees apply.
                                                    <br>  <br>
                                                    6. Termination Clause: There may be a termination clause that outlines the conditions under which the provider can terminate the service, such as non-payment or breach of contract.
                                                </div>
