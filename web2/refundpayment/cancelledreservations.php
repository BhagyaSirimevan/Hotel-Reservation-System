...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (!empty($time)) {
        $where .= " r.FunctionStartTime = '$time' OR r.FunctionEndTime = '$time' AND";
    }

    if (!empty($guest)) {
        $where .= " r.GuestCount LIKE '%$guest%' AND";
    }
                    ...
                    <div class="card-body pt-3">
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                <div class="card-title text-center"><h3>Your Cancelled Reservations</h3></div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                $customerid = $_SESSION['customerid'];
                                                    ...
                                                    $sql = "SELECT r.ReservationNo,r.ReservationDate,c.CancelDate,s.ResStatusName,rp.ResPaymentStatusName,e.EventName,h.HallName,r.FunctionStartTime,r.FunctionEndTime,r.GuestCount from tbl_reservation r "
                                                       . "LEFT JOIN rescancelreason c ON c.ReservationNo=r.ReservationNo "
                                                       ...
                                                       . "LEFT JOIN tbl_respayment_status rp ON rp.ResPaymentStatusId=r.ResPaymentStatusId "
                                                            . " LEFT JOIN tbl_refundpayment p ON p.ReservationNo=r.ReservationNo "
                                                       . "WHERE r.CustomerId='$customerid' "
                                                            . "AND r.ReservationStatusId='3' "
                                                       . "AND ((r.ResPaymentStatusId='2' AND DATEDIFF(r.ReservationDate,c.CancelDate)>14) "
                                                            . "OR (r.ResPaymentStatusId='3')) AND "
                                                            . "r.ReservationNo NOT IN(SELECT ReservationNo FROM tbl_refundpayment) $where";
                                                $db = dbConn();
                                                $result = $db->query($sql);
                                                ?>
