...
<main id="main" class="main">
 ...
 <section class="section dashboard">
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                    ...
                    <div class="card-title text-center"><h3>Your Pending Payment History</h3></div>
        <div class="row">
    ...
    <div class="table-responsive">
        ...
        $sql = "SELECT * FROM tbl_customerpayments c LEFT JOIN tbl_reservation r ON r.ReservationNo=c.ReservationNo LEFT JOIN tbl_paymentcategory p ON p.PaymentCategoryId=c.PaymentCategoryId LEFT JOIN tbl_paymentmethod m ON m.PaymentMethodId=c.PaymentMethodId LEFT JOIN tbl_bank_details b ON b.BankId=c.PaidBank LEFT JOIN tbl_paymentstatus s ON s.PaymentStatusId=c.PaymentStatusId WHERE c.AddUser='$userid' AND c.PaymentStatusId=1 $where";
        $db = dbConn();
        $result = $db->query($sql);
        ?>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?=($row['PaymentMethod']=='Cash')?'#':'edit.php?PaymentId='.$row['PaymentId']?>" class="<?=($row['PaymentMethod']=='Cash')? 'btn btn-warning btn-sm disabled' : 'btn btn-warning btn-sm' ?>">
