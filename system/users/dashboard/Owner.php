<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="row mt-4">
        ...
        <div class="card info-card sales-card bg-light">
            ...
            <div class="card-body">
                <h4 class="card-title">Total Reservations <span class="text-success">| This Year</span></h4>
    ...
    <div class="col-xxl-4 col-md-4">
        <div class="card info-card sales-card bg-light">
            ...
            <div class="card-body">
                <h4 class="card-title">Total Revenue <span class="text-success">| This Year</span></h4>
      ...
      <div class="col-xxl-4 col-md-4">
        <div class="card info-card sales-card bg-light">
            ...
            <div class="card-body">
                <h4 class="card-title">Total Customers <span class="text-success">| This Year</span></h4>
...
//        
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" >
        ...
        <div class="row mt-4">
            ...
            <div class="col">
                <input type="text" class="form-control" placeholder="Guest Count" name="guest" >
            </div>
            ...
            <div class="col">
                <button type="submit" class="btn btn-primary"><i class="fa fa-search" style="font-size:20px"> Search </i> </button>
            </div>
