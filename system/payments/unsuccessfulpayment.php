...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <h2>Unsuccessful Customer Payment List</h2>
...
//        
    ...
    <div class="table-responsive">
        ...
        $sql = "SELECT * FROM tbl_customerpayments c LEFT JOIN tbl_paymentcategory p ON p.PaymentCategoryId=c.PaymentCategoryId LEFT JOIN tbl_paymentmethod m ON m.PaymentMethodId=c.PaymentMethodId LEFT JOIN tbl_bank_details b ON b.BankId=c.PaidBank LEFT JOIN tbl_paymentstatus s ON s.PaymentStatusId=c.PaymentStatusId WHERE c.PaymentStatusId=3 OR c.PaymentStatusId=5 $where";
        $db = dbConn();
        $result = $db->query($sql);
        ?>
