    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST" && @$action == "save") {
            ...
            if (empty($message)) {
                ...
                $sql = "INSERT INTO tbl_customerpayments(ReservationNo,LastReservationPrice,PaymentCategoryId,PaidAmount,BalanceAmount,PaymentMethodId,PaidBank,PaidBranch,ReferenceNo,PaidDate,PaymentStatusId,AddUser,AddDate) "
                        . "VALUES('$resno','$lastresprice','$paymentcategory','$paidamount','$balanceamount','$paymentmethod','$paidbank','$paidbranch','$referenceno','$paiddate','4','$userid','$cdate')";
                $db->query($sql);
    ...
    <h2>Make Payment</h2>
        <form enctype="multipart/form-data" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
            ...
            <div class="row mt-2">
                ...
                <div class="col-md-3">
                    <img src="../../web2/assets/customer/assets/img/payment1.png" width="300px" height="250px" alt="alt"/>
