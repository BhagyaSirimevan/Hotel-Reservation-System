...
?>
            ...
            <div class="col-md-3">
                  <button type="button" class="btn btn-warning btn-sm" onclick="printReport('invoice')">Print</button>
            <button type="button" class="btn btn-warning btn-sm" onclick="exportReport('invoice', 'Invoice Info')">Export PDF</button>
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-6">
                    ...
                    <a href="paymentmenu.php" class="btn btn-success">Back to Dashboard</a>
