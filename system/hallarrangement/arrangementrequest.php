...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <h2>Hall Arrangement Request List</h2>
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" >
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                $sql = "SELECT * FROM tbl_hallarrangerequest a LEFT JOIN tbl_event e ON e.EventId=a.EventId "
                                                        ...
                                                        . "                LEFT JOIN tbl_hallarrangestatus s ON s.ArrangeStatusId=a.ArrangeStatusId WHERE a.ArrangeStatusId=1 "
                                                        . " $where";
                                                $db = dbConn();
                                                $result = $db->query($sql);
                                                ?>
