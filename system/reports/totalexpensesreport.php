        ...
        if (empty($message)) {
            ...
            if (empty($reporttype)) {
                if (!empty($startdate) && !empty($enddate)) {
                    $where .= "AND ip.AddDate BETWEEN '$startdate ' AND '$enddate' ";
                }
            } else{
                if($reporttype == 1){
                    $where .= "AND ip.AddDate = '$startdate ' ";
                }
                ...
                if($reporttype == 3){
                    if(!empty($month)){
                     $where .= "AND ip.AddDate LIKE '%$month%' "; 
                    }
                ...
                $where .= "AND YEAR(ip.AddDate) = '$year' ";  
            ...
            $db = dbConn();
            $sql2 = "SELECT ip.RefundBillNo,rp.ReservationNo,rp.RefundableAmount,ip.AddDate FROM tbl_refundpayment rp LEFT JOIN tbl_issuerefundpayment ip ON ip.RefundNo=rp.RefundNo WHERE rp.RefundStatusId=4 $where";
                ...
                if ($result2->num_rows > 0) {
                    ...
                    while ($row = $result2->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td><?= $total+=$row['RefundableAmount']?> </td>
