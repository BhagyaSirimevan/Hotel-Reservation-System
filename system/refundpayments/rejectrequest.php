...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <h2>Reject Refund Payment List</h2>
...
//        
    ...
    <div class="table-responsive">
        ...
        $sql = "SELECT * FROM tbl_refundpayment r LEFT JOIN tbl_paymentmethod m ON m.PaymentMethodId=r.PaymentMethodId LEFT JOIN tbl_refund_status s ON s.RefundStatusId=r.RefundStatusId WHERE r.RefundStatusId=3 $where";
        $db = dbConn();
        $result = $db->query($sql);
        ?>
