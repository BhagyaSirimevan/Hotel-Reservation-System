...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <h2>Approved Refund Payment List</h2>
...
//        
    ...
    <div class="table-responsive">
        ...
        $sql = "SELECT * FROM tbl_refundpayment r LEFT JOIN tbl_paymentmethod m ON m.PaymentMethodId=r.PaymentMethodId LEFT JOIN tbl_refund_status s ON s.RefundStatusId=r.RefundStatusId LEFT JOIN tbl_bank b ON b.BankId=r.BankId WHERE r.RefundStatusId=2 $where";
        $db = dbConn();
        $result = $db->query($sql);
        ?>
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            if ($_SESSION['userrole'] == "Billingclerk") {
                                ?>
                                 <td><a href="issuerefund.php?RefundNo=<?= $row['RefundNo'] ?>" class="btn btn-success btn-sm">
                                    Issue Refund</a></td>
